...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        //권한 정보를 이용해서 UserDetails 객체를 만들고 Authentication 리턴
        //사용자의 이름은 클레임의 주체(subject)로, 비밀번호는 비어있는 문자열로, 권한 정보는 앞서 변환한 authorities로 설정
        UserDetails principal = new User(claims.getSubject(), "", authorities);

        //사용자의 인증 정보
        //"": JWT 토큰을 사용하여 사용자를 인증하고 권한을 부여하는 경우에는 이미 인증이 완료되었으며, 사용자의 비밀번호는 필요하지 않음
